...
<body> 
 <h1> Tratamento de vetores em PHP - listaL2 - exercício3 </h1>
 ...
 <?php
  ...
  //ordenar o vetor de alunos, mantendo a associação entre valor e índice (a), na ordem inversa (descrescente - r), e ordenando pela nota (não pelo índice - que não tenha k no nome)
  arsort($vetorAlunos);
